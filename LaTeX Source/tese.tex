...
%% VERY IMPORTANT
%\usepackage{lscape}
\usepackage{nameref} % ref with names
...
% e.g.
% \majorfield[pt]={Engenharia Eletrotécnica}
 \majorfield[en]={Electrical and Computers Engineering}
...
\title[Adaptive Geolocation of IoT devices \\for Active and Assisted Living]{Adaptive Geolocation of IoT devices for Active and Assisted Living }

% Autor
% use [f] for female and [m] for male
\authorname[m]{Rafael Joaquim Oliveira Rodrigues}{}
\authordegree{Bachelor of Science in Electrical and Computer Engineering}
...
% use [f] for female and [m] for male
\adviser[m]{Ricardo Luís Rosa Jardim Gonçalves}{Full Professor}{\\& NOVA University of Lisbon} 
...
% use [f] for female and [m] for male
\coadviser[m]{João Filipe dos Santos Sarraipa}{Invited Assistant\\& Professor}{NOVA University of Lisbon}
...
\addlisttofrontmatter{\glsnogroupskiptrue\setlength{\glsdescwidth}{0.8\textwidth}\printnoidxglossaries}  % The Glossary and List of 
