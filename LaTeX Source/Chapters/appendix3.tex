...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{List of code: TTN Decoder }
...
return {
   wifiAPs:null ,
   timestamp:time,
   location:{ lat:lat, lon:lon, alt:alt, hdop:hdop, vdop:vdop, pdop:pdop,},
  batteryLevel:bl,
  sensor:{
...
return {
   wifiAPs: { mac_1: mac1, rssi_1:rssi1, mac_2: mac2, rssi_2:rssi2, 
   mac_3: mac3, rssi_3:rssi3 },
   timestamp:time1,
   location:{lat:lat1, lon:lon1, alt:alt1, hdop:hdop1, vdop:vdop1, pdop:pdop1},
  batteryLevel:bl1,
  sensor:{
    accelerometer:{ x:acc1x, y:acc1y, z:acc1z }
  }
};
}
}
